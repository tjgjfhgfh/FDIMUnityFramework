...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static void AddArrayMetadata(Type type)
        {
            ...
            {
                if (data.IsList && p_info.Name != "Item")
                    continue;
        ...
        private static void AddObjectMetadata(Type type)
        {
            ...
            foreach (PropertyInfo p_info in type.GetProperties())
            {
                if (data.IsDictionary && p_info.Name == "Item")
                {
                    ParameterInfo[] parameters = p_info.GetIndexParameters();
        ...
        public static object ToObject(Type type, string json, bool throwExcpetion)
        {
            var reader = new JsonReader(json);
            return ReadValue(type, reader, throwExcpetion);
        }

        public static object ToObject(Type type, string json)
        {
            return ReadValue(type, new JsonReader(json));
        }
        ...
        public static T ToObject<T>(string json, bool throwException)
        {
            JsonReader reader = new JsonReader(json);
