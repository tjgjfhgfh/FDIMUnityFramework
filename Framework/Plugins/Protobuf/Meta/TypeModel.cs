...
namespace ProtoBuf.Meta
{
        ...
        internal static MethodInfo ResolveListAdd(TypeModel model, Type listType, Type itemType, out bool isList)
        {
            ...
            if (add == null)
            {
                ...
                bool forceList = listTypeInfo.IsInterface &&
                                 listTypeInfo == model.MapType(typeof(System.Collections.Generic.IEnumerable<>))
...
#else
                Type constuctedListType = model.MapType(typeof(System.Collections.Generic.ICollection<>))
                    .MakeGenericType(types);
#endif
...
#else
            // more convenient GetProperty overload not supported on all platforms
            foreach (PropertyInfo indexer in listType.GetProperties(BindingFlags.Instance | BindingFlags.Public |
...
#else
            return pair.IsGenericType && pair.GetGenericTypeDefinition() ==
 ...
 typeof(System.Collections.Generic.Dictionary<,>).MakeGenericType(genericTypes);
...
#else
                    if (listType.IsGenericType && listType.GetGenericTypeDefinition() ==
        ...
        public object DeepClone(object value)
        {
            ...
            else if (GetWireType(Helpers.GetTypeCode(type), DataFormat.Default, ref type, out modelKey) !=
